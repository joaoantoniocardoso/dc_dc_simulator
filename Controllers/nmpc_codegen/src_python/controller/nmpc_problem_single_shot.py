...
class Single_shot_definition:
    ...
    def __init__(self, controller):
        ...
        self._period_steps = controller.model.step_number // (
            controller.model.number_of_inputs + 1
        )
    ...
    def generate_cost_function(self):
        ...
        for i in range(1, self._controller.horizon + 1):
            ...
            for size in range(number_inputs):
                ...
                for j in range(self._period_steps):
                    ...
                    cost = cost + self._controller.generate_cost_constraints(
                        current_state, input[size], size, constraint_weights
                    )
            ...
            for j in range(self._period_steps):
                ...
                cost = cost + self._controller.generate_cost_constraints(
                    current_state, 1 - sum_of_input, size + 1, constraint_weights
                )
